...
ただし **"STOP" は最後の手段です。** 店が自分で決められる候補（人員の要件、
経験者の要件、人件費）が残っているうちは、まずそれを試してください。
それらは誰にも予定を変えてもらわずに済みます。
"STOP" を使うのは、残っているのが「人に予定を変えてもらう」「約束した時間を
渡せなくなる」といった候補だけになったときです。
