...
AIの使いどころは、**決まりで書けないところに絞ると強い**というのが実感です。

並べ方をAIに作らせなかったのは、実際に作らせて測ったからです。
測らずに決めていたら、「なんとなくAIは苦手そう」以上のことは言えませんでした。

防御も同じでした。
正規表現で指示文を検出する仕組みを入れて満足していましたが、切って測ったら3/10しか捕まえていません。
効いていたのは検出ではなく、その先の囲いと確認です。

作る前の見込みはだいたい外れます。
測れる形にしておくと、外れたことに気付けます。
